export const CLASSES = [
  ...
  { id: 'assassin', name: 'Assassin', health: 9, description: 'Assassins can sneak attack with 3/5 yellow letters' },
...
export const BOSSES = [
  ...
  },
  {
    ...
    enhancedEffect: 'Take extra damage for using graveyard words.',
    announcement: 'Your quest is to defeat the Necromancer. Take extra damage from using the same word multiple times.',
    enhancedAnnouncement: 'You found the boss! Send him to his grave!',
  },
  {
    id: 'plague-lord',
    name: 'Plague Lord',
